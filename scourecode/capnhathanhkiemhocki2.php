<?php
    ...
    if (!isset($_SESSION["username"]) ) {
     ...
     WHERE hanhkiem.MALOP = '$MALOP' AND HOCSINH.MALOP='$MALOP' AND HOCKY= 2 and hanhkiem.MAHS='$MAHS'
     LIMIT 0, 25";
...
<form action="updatehanhkiemhocki2.php" method="post">
          <div class="text"><h3>Cập nhật hạnh kiểm học sinh</h3></div>
            ...
            <button type="submit" class="btn btn-success" name="capnhathanhkiem">Cập nhật hạnh kiểm học sinh</button>
       </form>
</body>