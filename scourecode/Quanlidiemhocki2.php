        ...
        <table class="table table-hover">
          ...
          <?php
            ...
            $lietke_sql = "SELECT * FROM DIEMMONHOC AS dm
               INNER JOIN HOCSINH AS hs ON dm.MAHS = hs.MAHS WHERE dm.MALOP = '$MALOP' AND hs.MALOP='$MALOP'and dm.MAMH ='$MHGV' AND HOCKY= 2 order by dm.MAHS
               LIMIT 0, 25";
            ...
            ?>
                ...
                <td><a class="btn btn-primary" href="capnhatdiemhocki2.php?mahs=<?php echo $lietke_row['MAHS']; ?>">
                          Cập nhật
                     </a>
                </td>
             </tr>
