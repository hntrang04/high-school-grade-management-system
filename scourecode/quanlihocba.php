 ...
 <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="quanlihocba.php">Quản lí học bạ</a>
    </div>
...
<div class="container mt-3">
        <div class="text-center">
             <h2>Danh sách các lớp đang đảm nhận học bạ</h>
        </div>
        <table class="table table-hover">
          ...
          <?php
            include('connect.php');
            $lietke_sql = " SELECT * FROM LOPHOC WHERE MAGV_CNHIEM ='$MGV'";
            ...
            ?>
              <tr>
                ...
                <td><a class="btn btn-primary" href="quanlihocbaki1.php?malop=<?php echo $lietke_row['MALOP']; ?>">
                          Học kì 1
                     </a>
                     <a class="btn btn-primary" href="quanlihocbaki2.php?malop=<?php echo $lietke_row['MALOP']; ?>">
                          Học kì 2
                     </a>
                     <a class="btn btn-primary" href="quanlihocbacanam.php?malop=<?php echo $lietke_row['MALOP']; ?>">
                          Cả năm
                     </a>
                </td>
             </tr>
