...
<div class="container mt-3">
        <div class="text-center">
             <h2>Danh sách các lớp đang chủ nhiệm</h>
        </div>
          ...
          <?php
            ...
            ?>
              <tr>
                ...
                <td><a class="btn btn-primary" href="quanlihanhkiemki1.php?malop=<?php echo $lietke_row['MALOP']; ?>">
                          Học kì 1
                     </a>
                     <a class="btn btn-primary" href="quanlihanhkiemki2.php?malop=<?php echo $lietke_row['MALOP']; ?>">
                          Học kì 2
                     </a>
                </td>
             </tr>
