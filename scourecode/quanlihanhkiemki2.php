 ...
 <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="QuanLihanhkiemki2.php">Quản lí hanh kiểm</a>
    </div>
        ...
        <table class="table table-hover">
          ...
          <?php
            ...
            $lietke_sql = "SELECT * FROM hanhkiem AS hk
               INNER JOIN HOCSINH AS hs ON hk.MAHS = hs.MAHS WHERE hk.MALOP = '$MALOP' AND hs.MALOP='$MALOP' AND HOCKY= 2 order by hk.MAHS
               LIMIT 0, 25";
            ...
            ?>
                ...
                <td><a class="btn btn-primary" href="capnhathanhkiemhocki2.php?mahs=<?php echo $lietke_row['MAHS']; ?>">
                          Cập nhật
                     </a>
                </td>
             </tr>
