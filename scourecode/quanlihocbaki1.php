...
<div class="container -fluid">
        ...
        <table class="table table-hover">
          ...
          <?php
            include('connect.php');
            $lietke_sql = "SELECT * FROM hocbahocki AS hbhk
               INNER JOIN HOCSINH AS hs ON hbhk.MAHS = hs.MAHS WHERE hbhk.MALOP = '$MALOP' AND hs.MALOP='$MALOP' AND HOCKY= 1 order by hbhk.MAHS
               LIMIT 0, 25";
            ...
            ?>
                ...
                <td><?php echo $lietke_row['DTBTOANHK'];?> </td>
                <td><?php echo $lietke_row['DTBVANHK'];?></td>
                <td><?php echo $lietke_row['DTBANHHK'];?></td>
                <td><?php echo $lietke_row['LOAIHK'];?></td>
                <td><?php echo $lietke_row['DTBHK'];?></td>
