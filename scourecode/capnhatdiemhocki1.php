<?php
    ...
    if (!isset($_SESSION["username"]) ) {
     ...
     WHERE DIEMMONHOC.MALOP = '$MALOP' AND HOCSINH.MALOP='$MALOP' AND DIEMMONHOC.MAMH ='$MHGV' AND HOCKY= 1 AND DIEMMONHOC.MAHS='$MAHS'
     LIMIT 0, 25";
     $DIEM_result = mysqli_query($db, $DIEM_sql);
...
<form action="updatediemhocki1.php" method="post">
