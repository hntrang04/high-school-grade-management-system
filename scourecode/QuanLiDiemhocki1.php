...
<div class="container mt-3">
        ...
        <table class="table table-hover">
          ...
          <?php
            include('connect.php');
            $lietke_sql = "SELECT * FROM DIEMMONHOC AS dm
               INNER JOIN HOCSINH AS hs ON dm.MAHS = hs.MAHS WHERE dm.MALOP = '$MALOP' AND hs.MALOP='$MALOP'and dm.MAMH ='$MHGV' AND HOCKY= 1 order by dm.MAHS
               LIMIT 0, 25";
            ...
            ?>
                ...
                <td> 
                    <p><?php echo $lietke_row['DIEMHS1_1'];?></p>
                    <p><?php echo $lietke_row['DIEMHS1_2'];?></p>
                    <p><?php echo $lietke_row['DIEMHS1_3'];?></p>
                </td>
                <td>
                     <p><?php echo $lietke_row['DIEMHS2_1'];?></p>
                     <p><?php echo $lietke_row['DIEMHS2_2'];?></p>
                </td>
                <td><?php echo $lietke_row['DIEMHS3'];?></td>
                <td><?php echo $lietke_row['DTBMH'];?></td>
                <td><a class="btn btn-primary" href="capnhatdiemhocki1.php?mahs=<?php echo $lietke_row['MAHS']; ?>">
                          Cập nhật
                     </a>
                </td>
             </tr>
